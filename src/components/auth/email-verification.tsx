          ...
          <div className="text-center">
            ...
            <div className="space-y-4 animate-slide-up animate-delay-300">
              <button
                ...
                disabled={isLoading}
                className="w-full bg-green-600 hover:bg-green-500 text-white py-3 rounded-lg transition-all duration-300 disabled:opacity-50 font-medium btn-hover-glow animate-float"
              >
                {isLoading ? (
              ...
              <button
                ...
                className="w-full bg-gray-800 hover:bg-gray-700 text-white py-3 rounded-lg transition-all duration-300 font-medium"
              >
                Back to Login
              </button>
            </div>
